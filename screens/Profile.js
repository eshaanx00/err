      ...
      return (
        ...
        <View style={styles.screenContainer}>
          ...
          <View style={styles.themeContainer}>
            ...
            <Switch style={{transforms:[{scaleX:1.3},{scaleY:1.3}]}} trackColor={{false:"#767577",true:'white'}} 
            thumbColor={this.state.isEnabled?"#ee8249":"#F4F3F4"} ios_backgroundColor="#3e3e3e" onValueChange={()=>this.toggleSwitch()}
